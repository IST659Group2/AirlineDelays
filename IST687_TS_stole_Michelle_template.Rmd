...
#used only_delays data frame for the same rationale
```{r}
...
```
December has the most delays.


###Which day of the week has the most delay
#used only_delays data frame for the same rationale
```{r}
#sort month in chronological order
...
ggplot(df_dayOfMonth, aes(x = DayOfMonth, y = Freq, group = 1)) + 
      ...
      #theme(axis.text.x = element_text(angle = 90, hjust = 1))
```
22th of the month has the most delays
